...
class AdapterPreview extends Component{
    ...
    render(){
        ...
        const renderCardContent=(
            ...
            <div className="headerContainer">
            <div className="adapterTextContainer">
            <span className="adapterCount">Adpater 1</span>
            <span className="adapterType">File Adapter</span>
            </div>
            ...
            <span className="alginValue">Integration Type</span>
            </div>
            <div class="colContainer">
            <span className="alignHeader">Integration Name</span>
            <span className="alginValue">Integration Name</span>
            </div>
            <div class="colContainer">
            ...
            <span className="alginValue">Host Details</span>
            </div>
            <div class="colContainer">
            <span className="alignHeader">Source Directory</span>
            <span className="alginValue">Source Directory</span>
            </div>
            <div class="colContainer">
            ...
            <span className="alginValue">Number of retries</span>
            </div>
            <div class="colContainer">
            <span className="alignHeader">File naming conventions</span>
            <span className="alginValue">File naming conventions</span>
            </div>
            <div class="colContainer">
            <span className="alignHeader">Monitor sub directories</span>
            <span className="alginValue">Monitor sub directories</span>
            </div>          
            </div>
            </div>
        );
        ...
        return(
            <div>
                ...
                <span className="headLine">Adpater</span>
                <span className="addButtonContainer">
                <Button id="save" text="Add New" aria-label="add new" isCallToAction />
                </span>
                </div>
                <div className="cardContainer">
                    <Card
